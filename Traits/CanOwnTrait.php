...
{
    /**
     * Checks if the model is the owner of the $ownable model by comparing IDs can be used for OO and OM relations
     *
    ...
    /**
     * Checks if the model is the owner of the $ownable model can be used for polymorphic relations
     *
     * @param null|string $morphableKeyName
     * @param null|string $morphableTypeName
     * @param null|string $localKey
     */
